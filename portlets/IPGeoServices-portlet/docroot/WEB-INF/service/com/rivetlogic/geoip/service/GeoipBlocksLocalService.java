...
/**
 * Provides the local service interface for GeoipBlocks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author charles.rodriguez
 * @see GeoipBlocksLocalServiceUtil
...
public interface GeoipBlocksLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GeoipBlocksLocalServiceUtil} to access the geoip blocks local service. Add custom service methods to {@link com.rivetlogic.geoip.service.impl.GeoipBlocksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
